...
def generate_dag() -> None:
    dbt_home = "/opt/airflow/dbts_dremio"
    dbt_target = "dev"
    ...
    start_ingestion >> task_dbt_run_ingestion >> end_ingestion
    end_ingestion >> start_bronze >> task_dbt_run_bronze >> end_bronze
    end_bronze >> start_silver >> task_dbt_run_silver >> end_silver
    end_silver >> start_gold >> task_dbt_run_gold >> end_gold
